...
/** Class for providing a dialog that lets the user specify values for tag attributes
  */
public class FontSelectorDialog extends BasicDialog implements ItemListener {

    private Vector vcFontnames = (Vector)null;
    private final BasicCombo jcmbFontlist;
	...
	jcmbFontlist = new BasicCombo(vcFontnames);

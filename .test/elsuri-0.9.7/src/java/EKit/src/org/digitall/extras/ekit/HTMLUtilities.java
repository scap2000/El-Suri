...
*/
    ...
    /** Diese Methode fï¿½gt durch String-Manipulation in jtpSource
    ...
    /** Diese Methode lï¿½scht durch Stringmanipulation in jtpSource das ï¿½bergebene Element,
	  * Alternative fï¿½r removeElement in ExtendedHTMLDocument, mit closingTag wird angegeben
	  * ob es ein schlieï¿½enden Tag gibt
	  */
    ...
    /** Diese Methode gibt jeweils den Start- und Endoffset des Elements
	  * sowie dem entsprechenden schlieï¿½enden Tag zurï¿½ck
	  */
	...
	int caret = -1;
	// aktuelle Position im sourceString
    ...
    /* Diese Methode prï¿½ft ob der ï¿½bergebene Tag sich in der Hierachie nach oben befindet */
    ...
    /* Diese Methoden geben das erste gefundende dem ï¿½bergebenen tags entsprechende Element zurï¿½ck */
    ...
    /* Diese Methoden entfernen Attribute aus dem SimpleAttributeSet, gemï¿½ï¿½ den ï¿½bergebenen Werten, und
		geben das Ergebnis als SimpleAttributeSet zurï¿½ck*/

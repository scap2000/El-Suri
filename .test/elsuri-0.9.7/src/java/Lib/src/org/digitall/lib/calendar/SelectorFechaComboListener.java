...
*/
/**
 * SelectorFechaComboListener.java
 *
 * */
...
public class SelectorFechaComboListener extends Observable implements ItemListener {

    SelectorFechaComboListener(SelectorFechaPanel calendar) {

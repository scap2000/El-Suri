...
*/
/**
 * GaiaTiposCultosyCulturaList.java
 *
 * */
...
public class GaiaTiposCultosyCulturaList extends BasicPrimitivePanel {
    ...
    private GaiaTipoCultoyCultura tipoCultoyCultura;
    private boolean addAction = true;
    
    public GaiaTiposCultosyCulturaList() {
	try {
	    jbInit();
	} catch (Exception e) {
	    e.printStackTrace();
	...
	panelData.setBorder(BorderPanel.getBorderPanel("Agregar nuevo Tipo de Culto/Cultura"));
	...
	listPanel.setParams("gis_oran.getAllTiposCultosyCultura", "''", headerList);
    }
	...
	if (tipoCultoyCultura == null){
	    tipoCultoyCultura = new GaiaTipoCultoyCultura(Integer.parseInt(""+ dataRow.elementAt(0)), dataRow.elementAt(1).toString());
	} else {
	    tipoCultoyCultura.setIdTipoCultoyCultura(Integer.parseInt(""+ dataRow.elementAt(0)));
	    tipoCultoyCultura.setNombre(dataRow.elementAt(1).toString());
	}
    }
    
    private void loadData(){
	tfName.setValue(tipoCultoyCultura.getNombre());
	addAction = false;
    }
	...
	if (addAction){
	    tipoCultoyCultura = new GaiaTipoCultoyCultura();
	}
	tipoCultoyCultura.setNombre(tfName.getString());
	tipoCultoyCultura.saveData();

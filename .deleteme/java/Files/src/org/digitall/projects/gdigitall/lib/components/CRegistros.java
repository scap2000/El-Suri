...
public class CRegistros extends JPanel implements ActionListener {
   ...
   */
    ...
    public CRegistros(int CantRegistros, String Esquema, String Tabla, int[] TCol, int[] TamCol, boolean _checks, boolean _boton) {
        try {
            //      this.getHeight() = this.getHeight()anel;
            //     tventana = 315;
            CR = CantRegistros;
                ...
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    if (!tmodelo.isSelectionEmpty()) {
                        ...
                        try {
                            ...
                            OP_Proced.Mensaje(x.getMessage(), "Error_table.getSelectionModel.addListSelectionListener");
                        }
                    }
                }
            }
                        ...
                        Thread Tarea = new Thread(new Runnable() {
                                    public void run() {
                                        try {
                                            ...
                                            OP_Proced.RefreshTabla(esquema, tabla, consulta + filtro, CR, Liminf, modelo, table, jScrollPane1, checks, boton);
                                            if (primeraVez) {
                                                RemueveCol();
                                                TamanioColumna();
                                                primeraVez = false;
    ...
    /** @deprecated
 * nunca funcionï¿½, pero estarï¿½a bueno poder implementarlo
 */
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            if (selected.equalsIgnoreCase("true")) {
                try {
                    ...
                    OP_Proced.Mensaje(x.getMessage(), "Error_getSelecteds");
                }
            }
        }
    ...
    public void setEditorColumna(int _columna, JComboBox _combobox) {
        try {
            ...
            OP_Proced.Mensaje(x.getMessage(), "Error_SetEditorColumna");
        }
    }
    ...
    public void setTCol(int[] _tcol) {
        tcol = _tcol;
    }

    public void setTamCol(int[] _tamcol) {
        tamcol = _tamcol;
    }
}

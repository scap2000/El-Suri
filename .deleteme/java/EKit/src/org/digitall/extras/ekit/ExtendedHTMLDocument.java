...
public class ExtendedHTMLDocument extends HTMLDocument {
    ...
    /** ï¿½berschreibt die Attribute des Elements.
  *
  * @param e Element bei dem die Attribute geï¿½ndert werden sollen
  * @param a AttributeSet mit den neuen Attributen
  * @param tag Angabe was fï¿½r ein Tag das Element ist
  */

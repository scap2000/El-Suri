...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
	try {
	    Environment.SYSTEM_VERSION = "ElSuriDesktop [2010-10-07] ß";
	    setUndecorated(true);
	    setIconImage(IconTypes.lock_16x16.getImage());

	    final BasicDialog _licenseDialog = new BasicDialog() {
	        public void closeBasicDialog() {
	            if (!Advisor.question("Acuerdo de Licencia", "¿Acepta el acuerdo de licencia?")) {
	                System.exit(0);
	            } else {
		        Advisor.messageBox("<html><p align=center>En la siguiente pantalla introduzca<br><u>Usuario</u>: demo<br><u>Contraseña</u>: demo123<html>", "Usuario/Contraseña");
			dispose();
		    }
	        }
	    };

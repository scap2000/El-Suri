...
"
echo "genCerts.sh --> Generación de certificados SSL"
echo "A continuación se le pedirán los datos necesarios para"
echo "la generación de los certificados SSL correspondientes"
...
cp *.cer ../java/Resources/src/org/digitall/lib/ssl/certs
cd -

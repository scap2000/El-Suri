...
//            if (!contratoPlanDePago.isImpreso()) {
	...
	if(_alicuotaContribucion.getIdcontribucion() == 1 
	   || _alicuotaContribucion.getIdcontribucion() == 131
	   || _alicuotaContribucion.getIdcontribucion() == 132) {  // Se trata de un libre deuda de un automotor

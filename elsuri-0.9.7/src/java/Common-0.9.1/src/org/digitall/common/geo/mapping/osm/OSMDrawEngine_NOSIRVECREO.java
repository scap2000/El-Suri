 ...
 *
 */
public class OSMDrawEngine_NOSIRVECREO extends BasicPrimitivePanel implements TileLoaderListener, MouseMotionListener {
     ...
     */
    public OSMDrawEngine_NOSIRVECREO() {
        this(new MemoryTileCache(), 4);
        //new DefaultMapController(this);
    }

    public OSMDrawEngine_NOSIRVECREO(TileCache tileCache, int downloadThreadCount) {
        super();
    ...
    public CoordinateViewer getCoordinateViewer() {
	return coordinateViewer;
    }

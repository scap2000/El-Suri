...
public interface TileSource {
    ...
    /**
     * Specifies the maximum _currentZoomLevel value. The number of _currentZoomLevel levels is [0..
     * {@link #getMaxZoom()}].
     *
     * @return maximum _currentZoomLevel value that has to be smaller or equal to
     * {@link org.digitall.common.geo.mapping.osm.JMapViewer#MAX_ZOOM}
     */
    public int getMaxZoom();

    /**
     * Specifies the minimum _currentZoomLevel value. This value is usually 0.
     * Only for maps that cover a certain region up to a limited _currentZoomLevel level
     * this method should return a value different than 0.
     *
     * @return minimum _currentZoomLevel value - usually 0
     */
    ...
    /**
     * @param zoom The optional _currentZoomLevel level for the view.

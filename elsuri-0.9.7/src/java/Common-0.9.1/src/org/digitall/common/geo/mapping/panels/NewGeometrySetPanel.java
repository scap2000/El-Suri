...
public class NewGeometrySetPanel extends BasicPrimitivePanel {
    ...
    private void loadServerData() {
        serverURL = layerTree.getDrawEnginePanel().getEngineConfig().getPropietaryServerURL();
        database = layerTree.getDrawEnginePanel().getEngineConfig().getPropietaryDatabase();
        user = layerTree.getDrawEnginePanel().getEngineConfig().getPropietaryUser();
        password = layerTree.getDrawEnginePanel().getEngineConfig().getPropietaryPassword();
    }

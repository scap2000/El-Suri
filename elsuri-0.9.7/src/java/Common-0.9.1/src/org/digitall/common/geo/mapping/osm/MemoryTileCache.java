...
/**
 * {@link org.digitall.common.geo.mapping.osm.interfaces.TileCache}implementation that stores all {@link org.digitall.common.geo.mapping.osm.Tile}objects in
 * memory up to a certain limit ( {@link #getCacheSize()}). If the limit is
 * exceeded the least recently used {@link org.digitall.common.geo.mapping.osm.Tile}objects will be deleted.
 *
...
public class MemoryTileCache implements TileCache {
    ...
    /**
     * Changes the maximum number of {@link org.digitall.common.geo.mapping.osm.Tile}objects that this cache holds.
     *
     * @param cacheSize
    ...
    /**
     * Linked list element holding the {@link org.digitall.common.geo.mapping.osm.Tile}and links to the

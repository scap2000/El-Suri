...
public class LayerFilterPanel extends BasicPanel {
	...
	if (layerFilter.getStyleConfig().getSymbol() != -1) {
	    ...
	    lblColor.setIcon(IconTypes.getScaledIcon(new ImageIcon(layerTree.getDrawEnginePanel().getEngineConfig().getSymbol(layerFilter.getStyleConfig().getSymbol())), 16, 18));
	} else {

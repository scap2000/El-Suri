...
public class MainPanel extends BasicPanel {
    ...
    private BasicButton btnAvl = new BasicButton();//IconTypes.avl_32x32);
	...
	//btnAvl.setRolloverIcon(IconTypes.avl_ro_32x32);
	...
	lblTopLeft.setToolTipText("http://www.mapcom.com.ar/ctrlciudadano");
	...
	BrowserLauncher.openURL("http://www.mapcom.com.ar/ctrlciudadano");
    }

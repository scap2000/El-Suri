...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
	try {
	    Environment.SYSTEM_VERSION = "CtrlCiudadano [2016-05-023] ß";
	    setUndecorated(true);
	    ...
	    loginWindow.setLabelForegroundColor(Color.WHITE);
	...
	desktops[1] = new BasicDesktop(Boot.REPORTS_MODULE, Environment.MODULE_REPORTS);
	desktops[2] = new BasicDesktop(Boot.AVL_MODULE, Environment.MODULE_AVL);
	desktops[3] = new BasicDesktop(Boot.GAIA_MODULE, Environment.MODULE_GAIA);
	desktops[4] = new BasicDesktop(Boot.STICKYNOTES_MODULE, Environment.MODULE_STICKYNOTES);
	...
	public void actionPerformed(ActionEvent actionEvent) {
	    ...
	    Boot.rcAVL(Boot.INIT_START, Environment.getDesktop(Environment.MODULE_AVL));
	...
	if ((SSLConfig.class.getResourceAsStream(SSLConfig.KEY_FILE_PATH) != null) && (SSLConfig.class.getResourceAsStream(SSLConfig.TRUST_FILE_PATH) != null)) {
	} else {

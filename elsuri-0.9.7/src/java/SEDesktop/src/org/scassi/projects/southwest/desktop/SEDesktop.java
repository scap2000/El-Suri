...
public class SEDesktop {

    private MainFrame frame;

    public SEDesktop(GraphicsDevice[] devices) {
	Environment.mainClass = SEDesktop.class;
	...
	*/
	...
	OrganizationInfo.setOrgName("Southwest Electronics");
	OrganizationInfo.setTitle("Southwest\nElectronics");
	OrganizationInfo.setShortName("Southwest Electronics");
	OrganizationInfo.setDescription("Southwest Electronics");
        OrganizationInfo.setAddress("475 Washington Blvd."); 
	OrganizationInfo.setShortAddress("475 Washington Blvd.");
	OrganizationInfo.setCuit("");
	OrganizationInfo.setZipCode("");
	OrganizationInfo.setLocation("Marina del Rey");
	OrganizationInfo.setProvince("CA");
	OrganizationInfo.setCountry("USA");
        OrganizationInfo.setWebAddress("http://www.southwestelec.com");
        OrganizationInfo.setPhoneNumber1("");
        OrganizationInfo.setPhoneNumber2("");
	Environment.defaultLocation = "Marina del Rey (CA)";
	GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
	GraphicsDevice[] devices = env.getScreenDevices();
	new SEDesktop(devices);
    }

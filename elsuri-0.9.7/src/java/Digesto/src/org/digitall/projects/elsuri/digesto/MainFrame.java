...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
	try {
	    Environment.SYSTEM_VERSION = "ElSuriDigesto [2011-11-11] RC";
	    Environment.cfg = new ConfigFile(System.getProperty("user.home") + File.separator + "digesto.conf");
	    setUndecorated(true);
	...
	if (active) {
	    ...
	    setVisible(true);
	    sw.dispose();
	    Advisor.messagePopupWindow("¡Bienvenido al Digesto Legislativo!", "");

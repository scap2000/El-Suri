...
public class MainPanel extends BasicPanel {
	...
	jpBtnContainer.setSize(new Dimension(324, 64));
	...
	jpButtonsContainer.setSize(new Dimension(324, 52));
	...
	lblTopLeft.setToolTipText("http://www.elsuridesktop.com.ar");
	...
	BrowserLauncher.openURL("http://www.elsuridesktop.com.ar/");
    }

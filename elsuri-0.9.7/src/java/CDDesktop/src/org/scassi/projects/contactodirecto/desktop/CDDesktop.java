...
public class CDDesktop {
    ...
    public CDDesktop(GraphicsDevice[] devices) {
	Environment.mainClass = CDDesktop.class;
	...
	*/
	Environment.mainClass = CDDesktop.class;
	Boot.initGraphics();
	Environment.organization = "SCASSI";
	OrganizationInfo.setOrgName("SCASSI");
	OrganizationInfo.setTitle("SCASSI");
	OrganizationInfo.setShortName("SCASSI");
	OrganizationInfo.setDescription("SCASSI");
        OrganizationInfo.setAddress("Juana Moro de López 220"); 
	...
	OrganizationInfo.setCountry("Argentina");
        OrganizationInfo.setWebAddress("http://cdirecto.com");
        OrganizationInfo.setPhoneNumber1("+5493874752661");
        OrganizationInfo.setPhoneNumber2("+5493874752684");
        Environment.defaultLocation = "Salta (AR)";
        Environment.mediaServer = "http://172.20.30.210";
	GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
	GraphicsDevice[] devices = env.getScreenDevices();
	new CDDesktop(devices);
    }

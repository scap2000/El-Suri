...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
	try {
	    Environment.SYSTEM_VERSION = "DirectContact [2019-09-20] RC";
	    setUndecorated(true);
    ...
    public void firstLogin() {
        //Environment.cfg.setProperty("firstlogin", "true");
        if (!Environment.cfg.getProperty("firstlogin").equals("false")) {
            Environment.cfg.setProperty("firstlogin", "false");
            Advisor.messageBox("Atención, primero deberá cambiar su contraseña", "Primer inicio de sesión");
            ChangePassword pass = new ChangePassword(Environment.sessionUser);
            pass.setModal(true);
            pass.setVisible(true);
            Advisor.messageBox("Para volver a cambiar su contraseña mantenga presionado SHIFT y haga click en el botón \"Salir\" arriba a la derecha de su pantalla", "Cambiar contraseña");
        }
    }

    public void showLicense() {
	if (!Environment.cfg.getProperty("showlicense").equals("false")) {
	    final BasicDialog _licenseDialog = new BasicDialog(null, "Licencia de uso") {

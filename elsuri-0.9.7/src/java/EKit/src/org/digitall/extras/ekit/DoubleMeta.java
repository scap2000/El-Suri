...
class DoubleMeta implements Transformator {
   ...
   */
    private static final boolean SlavoGermanic(String in) {
   ...
   */
    private static final void MetaphAdd(StringBuffer primary, String main) {
	if (main != null) {
	    primary.append(main);
	}
    }

    private static final void MetaphAdd(StringBuffer primary, char main) {
	primary.append(main);
    }
   ...
   */
    private static final boolean isVowel(String in, int at, int length) {
	if ((at < 0) || (at >= length))
	    return false;
   ...
   */
    private static final boolean stringAt(String string, int start, int length, String[] list) {

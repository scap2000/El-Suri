...
public class PaneStudies extends BasicContainerPanel{
    ...
    private TFInput tfGraduacionDate = new TFInput(DataTypes.DATE, "EndDate",false);
	...
	jPanel1.add(tfGraduacionDate, null);
	...
	tfGraduacionDate.setBounds(new Rectangle(320, 140, 90, 35));
	tfGraduacionDate.setEnabled(false);
	tfGraduacionDate.setPreferredSize(new Dimension(89, 31));
	tfGraduacionDate.setSize(new Dimension(100, 35));
	...
	tfGraduacionDate.setValue(qualificationPerson.getDateGraduation());
	...
	qualificationPerson.setDateGraduation(Proced.setFormatDate(tfGraduacionDate.getString(), false));
	...
	if (e.getItem().equals("Cursando")) {	    
	    ...
	    tfGraduacionDate.setEnabled(true);     
	    tfStartDate.setEnabled(true);
	}
    }    

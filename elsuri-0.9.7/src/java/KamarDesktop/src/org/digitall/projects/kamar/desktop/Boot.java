 ...
 *
 * */
package org.digitall.projects.kamar.desktop;
...
import org.digitall.projects.kamar.taller.interfaces.CategoriasMain;
import org.digitall.projects.kamar.taller.interfaces.ComprobantesMain;
import org.digitall.projects.kamar.taller.interfaces.FlatRatesMain;
import org.digitall.projects.kamar.taller.interfaces.MarcasMain;
import org.digitall.projects.kamar.taller.interfaces.MecanicosMain;
import org.digitall.projects.kamar.taller.interfaces.OrdenesServicioMain;
import org.digitall.projects.kamar.taller.interfaces.ProveedoresMain;
import org.digitall.projects.kamar.taller.interfaces.ServiciosMain;
import org.digitall.projects.kamar.taller.interfaces.TallerMain;
import org.digitall.projects.kamar.taller.interfaces.TareasMain;
import org.digitall.projects.kamar.taller.interfaces.TiposMecanicaMain;
import org.digitall.projects.kamar.taller.interfaces.TiposVehiculoMain;
import org.digitall.projects.kamar.taller.interfaces.ordenservicio.PanelInformes;
...
public class Boot {
	...
	switch (_action) {
		...
		if (MAIN_MODULE_STATUS != STATUS_RUNNING) {
		    ...
		    new ExtendedInternalFrame("Tipos de Mecánica", IconTypes.habilidades, TiposMecanicaMain.class, true, _desktop);
		    new ExtendedInternalFrame("Tipos de Vehículo", IconTypes.habilidades, TiposVehiculoMain.class, true, _desktop);

		    new ExtendedInternalFrame("Mecánicos", IconTypes.habilidades, MecanicosMain.class, true, _desktop);
		    new ExtendedInternalFrame("Flat Rate Times", IconTypes.habilidades, FlatRatesMain.class, true, _desktop);

		    new ExtendedInternalFrame("Proveedores", IconTypes.habilidades, ProveedoresMain.class, true, _desktop);
		    new ExtendedInternalFrame("Comprobantes", IconTypes.habilidades, ComprobantesMain.class, true, _desktop);

		    new ExtendedInternalFrame("Tareas", IconTypes.habilidades, TareasMain.class, true, _desktop);
		    new ExtendedInternalFrame("Artículos", IconTypes.habilidades, ArticulosMain.class, true, _desktop);
		    new ExtendedInternalFrame("Categorías", IconTypes.habilidades, CategoriasMain.class, true, _desktop);
		    new ExtendedInternalFrame("Marcas", IconTypes.habilidades, MarcasMain.class, true, _desktop);

		    new ExtendedInternalFrame("Servicios", IconTypes.habilidades, ServiciosMain.class, true, _desktop);

		    //new ExtendedInternalFrame("Nueva Orden de Servicio", IconTypes.ver_crear_pedidos_de_materiales, PanelOrdenServicio.class, true, _desktop);
		    new ExtendedInternalFrame("Órdenes de Servicio", IconTypes.ver_crear_pedidos_de_materiales, OrdenesServicioMain.class, true, _desktop);

		    new ExtendedInternalFrame("Asignación de Mecánicos", IconTypes.configuracion_base_de_sueldos, TallerMain.class, true, _desktop);

		    new ExtendedInternalFrame("Informes", IconTypes.balance_de_sumas_y_saldos, PanelInformes.class, true, _desktop);

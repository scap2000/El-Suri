...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
	try {
	    Environment.SYSTEM_VERSION = "Kamar [2013-05-27]";
	    Environment.minVersion = 20110909;
	    setUndecorated(true);
	    setIconImage(IconTypes.lock_16x16.getImage());

	    checkCerts();
	    
	    Login loginWindow = new Login(Environment.organization, Environment.developer, true, false, false);

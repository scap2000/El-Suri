...
public class MainPanel extends BasicPanel {
	...
	jpButtonsContainer.setLayout(new BorderLayout());
	...
	jpButtonsContainer.add(btnMain, BorderLayout.CENTER);
	...
	lblTopLeft.setToolTipText("http://www.kamarsportplaza.com.ar");
	...
	BrowserLauncher.openURL("http://www.kamarsportplaza.com.ar");
    }

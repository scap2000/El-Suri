...
public abstract class OrganizationInfo {
    ...
    private static String orgName = "El Suri";
    private static String title = "El Suri";
    private static String shortName = "El Suri";
    private static String description = "El Suri Desktop - Software Libre para Gobierno Electrónico";
    private static String address = "Salta";
    private static String shortAddress = "Salta";
    private static String cuit = "00";
    ...
    private static String webAddress = "http://www.elsuridesktop.com.ar";

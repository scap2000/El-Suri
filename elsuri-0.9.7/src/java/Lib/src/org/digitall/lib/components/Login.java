...
public class Login extends JDialog {
    ...
    public Login(String Titulo, String Dependencia, boolean Inicio, boolean _logo, boolean _SSLConnection) {
	try {
	    titulo = Titulo;
	    dep = Dependencia;
	    inicio =  Inicio;
	...
	this(Titulo, Dependencia, Inicio, _logo, true);
    }
    ...
    public void setLabelForegroundColor(Color _color) {
	lblUser.setForeground(_color);
	lblPwd.setForeground(_color);
	lblServerList.setForeground(_color);
    }
	...
	if (_isServerReachable) {
		...
		if (SSLConnection) {
		    ...
		    LibSQL.setDataBaseString("jdbc:postgresql://" + serverURLs.elementAt(cbServerList.getSelectedIndex()) + ":" + SSLConfig.PG_SERVER_UNSECURED_PORT + "/" + serverDBs.elementAt(cbServerList.getSelectedIndex()));
		}

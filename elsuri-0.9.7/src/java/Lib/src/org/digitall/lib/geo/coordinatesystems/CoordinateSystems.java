...
public abstract class CoordinateSystems {
    ...
    {
	    final double EARTH_RADIUS_M = 6372795.0;
	    // Multiply by appropriate factor
	    return inAngDist * EARTH_RADIUS_M;
    }
     ...
     */
    public static double calculateDistanceBetween(LatLongCoord inPoint1, LatLongCoord inPoint2)
    {
	    ...
	    // phew
	    double phew = 2 * Math.asin(Math.sqrt(firstSine*firstSine + term2));
	    return convertRadiansToDistance(phew);
    }

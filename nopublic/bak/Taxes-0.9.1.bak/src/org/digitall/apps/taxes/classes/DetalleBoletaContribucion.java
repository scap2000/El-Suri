...
public class DetalleBoletaContribucion {
    ...
    public int saveData() {
        ...
        if (idDetalleBoletaContribucion == -1) {
            ...
            result = LibSQL.getInt("taxes.setDetalleBoletaContribucion",params); //falta crearla (verificar si es necesario)
        }
        return result;
    }
    ...
    public boolean itemCargado(String _item) {
        return LibSQL.getBoolean("taxes.esItemCargado",idBoletaContribucion +",'"+ _item +"'");
    }

...
public class Cadastral {
    ...
    public String getLeyendaLibreDeuda(String _impuesto){
	String resultado = "";
	String titular = reformat("" + this.getDomape().toUpperCase());
	String numDoc = reformat("" + this.getDomnudoc().toUpperCase());
	String catastro = reformat(("" + this.getCatastro() +"").toUpperCase());
	String seccion = reformat("" + this.getTecsec().toUpperCase());
	String manzana = reformat(("" + this.getTecman() + this.getTecmanl()).toUpperCase());
	String parcela = reformat(("" + this.getTecpar() + this.getTecparl()).toUpperCase());
	String categoria = reformat(("" + this.getIdCategoria()+"").toUpperCase());
	...
	_impuesto = reformat(_impuesto.toUpperCase());
	...
	resultado = "\t\tLa " + OrganizationInfo.getOrgName() + ", a través de la Dirección de Rentas - Sección Inmuebles, certifica que el " 
            + "catastro Nº " + catastro + ", según Padrón General de Inmuebles de la Provincia de " + OrganizationInfo.getProvince() 
	    + "; Sección: " + seccion + "; Manzana: " + manzana.trim() + "; Parcela: " + parcela.trim() + "; Categoría: " + categoria 
            + ", a nombre de "+ titular + "; DNI/CUIT/CUIL Nº: " + numDoc  
	    + ", se encuentra LIBRE DE TODO GRAVAMEN EN CUANTO A " +_impuesto+ " (hasta el día " + diaLibreCadena  + "/" + mesLibreCadena + "/" + anioHasta + ")."

...
public class PanelRegistrarBoletaCuotasAnticipos extends BasicPanel{
	...
	tfTotalPeriodosAdeudados.setText("$ 6,24");
	...
	btnGenerar.setBounds(new Rectangle(10, 435, 65, 30));
	btnGenerar.setToolTipText("Registrar Pago");
	...
	tfCondonacionIntereses1.setText("$ 3,12");

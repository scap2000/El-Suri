 ...
 * just as the BasicTable itself would. Events recieved from the model
 * are examined, sometimes manipulated (typically widened), and then
 * passed on to the TableSorter's listeners (typically the BasicTable).
...
public class TableSorter extends AbstractTableModel {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
	    ...
	    if (c instanceof BasicLabel) {
		BasicLabel l = (BasicLabel)c;
		l.setHorizontalTextPosition(BasicLabel.LEFT);

...
//public class ChWYLocalChatPanel extends BasicDialog {
	...
	try {
	    ...
	    writeOut(ChWYConfig.MESSAGE_ORIG + localUserName + ";" + ChWYConfig.ORGANIZATIONNAME + "MOSCONI" + ";" + ChWYConfig.MESSAGE_DEST + remoteUserName + ";" + ChWYConfig.MESSAGE_STRING + _message + ";");
	...
	////writeOut(ChWYConfig.USERNAME + _userName);
        ...
        writeOut(ChWYConfig.USERNAME + _userName+ ";" + ChWYConfig.ORGANIZATIONNAME + "MOSCONI;"+informacion.getParametros());
    }

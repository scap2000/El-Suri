...
public class FormDetalleEscrutinioPorCircuito extends BasicPrimitivePanel {
    ...
    private int[] sizeColumnList = { 64, 64, 170, 282, 139, 110 };
    private Vector dataRow = new Vector();
    private GridPanel listPanel = new GridPanel(1000, sizeColumnList, "Resultados ganadores por Circuito", dataRow);
    ...
    public FormDetalleEscrutinioPorCircuito() {
	try {
	    jbInit();
	} catch (Exception e) {
	    e.printStackTrace();
	...
	cbCargo.setBounds(new Rectangle(120, 20, 145, 35));
	...
	cbCircuito.setBounds(new Rectangle(325, 20, 80, 35));
	cbPartido.setBounds(new Rectangle(500, 20, 260, 35));
	cbCircuito.autoSize();
	cbPartido.autoSize();
	cbCargo.autoSize();
	...
	headerList.addElement("*");
        headerList.addElement("Partido Ganador");
        headerList.addElement("Cant. Mesas Ganadas");
        headerList.addElement("Total de Mesas");
        ...
        listPanel.setParams("escrutinio_salta.getDetalleEleccionesPorCircuito", "4,'',''", headerList);
    }
    ...
    public void refresh() {
        String params = ""+ cbCargo.getSelectedIndex() +",'"+ cbCircuito.getSelectedItem() +"','"+ cbPartido.getSelectedItem() +"'" ;

...
public class MainPanel extends BasicPanel {
    ...
    private BasicLabel lblVersion = new BasicLabel();
    private BasicLabel lblDataBase = new BasicLabel();
	...
	jpBottomLeft.add(lblDataBase, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	...
	jpBottomRight.add(lblVersion, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	...
	btnGaia.setToolTipText("Mini GIS - Demo");
	...
	lblVersion.setFont(new Font("Lucida Sans", Font.BOLD, 8));
	lblDataBase.setVisible(false);
	Timer updateInfo = new Timer(1000, new ActionListener() {

		public void actionPerformed(ActionEvent e) {
		    lblVersion.setText(LibSQL.getDataBase().split("/")[LibSQL.getDataBase().split("/").length - 1] + "@" + Environment.SYSTEM_VERSION);
		    lblVersion.setToolTipText(lblVersion.getText());
		}
	    });
	updateInfo.start();

...
public class MKDSalta {

    private MainFrame frame;

    public MKDSalta(GraphicsDevice[] devices) {
	...
	*/
	...
	Environment.mainClass = MKDSalta.class;
	Boot.initGraphics();
	...
	OrganizationInfo.setProvince("Provincia de Salta");

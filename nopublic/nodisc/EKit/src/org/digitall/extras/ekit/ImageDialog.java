...
public class ImageDialog extends BasicDialog implements ActionListener {

    private final String[] Borders = new String[] { "none", "solid", "dotted", "dashed", "double", "groove", "ridge", "inset", "outset" };
    private String[] BorderColors = new String[] { "none", "aqua", "black", "blue", "fuschia", "gray", "green", "lime", "maroon", "navy", "olive", "purple", "red", "silver", "teal", "white", "yellow" };
    ...
    private BasicTextField ImageAltText;
    private BasicTextField ImageWidth;
    private BasicTextField ImageHeight;
	...
	BasicScrollPane imageScrollPane = new BasicScrollPane(ImageList);
	...
	BasicScrollPane previewViewport = new BasicScrollPane(PreviewPane);
	previewViewport.setVerticalScrollBarPolicy(BasicScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
	previewViewport.setPreferredSize(new Dimension(250, 250));
	centerPanel.add(previewViewport);
	BasicPanel controlsPanel = new BasicPanel();
	controlsPanel.setLayout(new BoxLayout(controlsPanel, BoxLayout.Y_AXIS));
	BasicPanel altPanel = new BasicPanel();
	altPanel.setLayout(new BoxLayout(altPanel, BoxLayout.X_AXIS));
	altPanel.add(Box.createHorizontalStrut(10));
	BasicLabel imageAltTextLabel = new BasicLabel("Alternate Text:", SwingConstants.LEFT);
	altPanel.add(imageAltTextLabel);
	ImageAltText = new BasicTextField("");
	...
	BasicScrollPane wrapScrollPane = new BasicScrollPane(WrapList);
	...
	/*
		BasicPanel borderPanel = new BasicPanel();
		BasicLabel borderStyleLabel = new BasicLabel("Style:", SwingConstants.LEFT);
		...
		BasicScrollPane borderScrollPane = new BasicScrollPane(BorderList);
	...
	BasicLabel borderSizeLabel = new BasicLabel("Border Size:", SwingConstants.LEFT);
	...
	BasicScrollPane borderSizeScrollPane = new BasicScrollPane(BorderSizeList);
	...
	/*
		BasicLabel borderColorLabel = new BasicLabel("Color:", SwingConstants.LEFT);
		...
		BasicScrollPane borderColorScrollPane = new BasicScrollPane(BorderColorList);
	...
	BasicButton applyButton = new BasicButton("Apply");

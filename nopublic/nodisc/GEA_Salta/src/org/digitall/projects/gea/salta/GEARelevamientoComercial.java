...
public class GEARelevamientoComercial extends BasicPrimitivePanel {
	...
	try {
	    ...
	    cityMap.setVisible(true);
            ...
            GeometrySet gsetComerciosHis2002 = new GeometrySet("gis_salta", "comercios_his_2002", "the_geom", "1=1 AND st_isvalid(the_geom)", "idparcela");
            GeometrySet gsetComerciosHis2009 = new GeometrySet("gis_salta", "comercios_his_2009", "the_geom", "1=1 AND st_isvalid(the_geom)", "idparcela");
            ...
            Layer castanares_grupos_poligonos_2009 = new Layer("Castañares (Grupos Polígonos 2009)", gsetCastanaresGruposPoligonos2009);
            ...
            Layer castanares_grupos_textos_2009 = new Layer("Castañares (Grupos Textos 2009)", gsetCastanaresGruposTextos2009);
            ...
            consultasComerciosGroup.add(comercios_consultas_1);
            consultasComerciosGroup.add(comercios_consultas_2);
            consultasComerciosGroup.add(comercios_consultas_3);
            consultasComerciosGroup.add(comercios_consultas_4);

            consultasPublicidadesGroup.add(publicidad_formato);
            consultasPublicidadesGroup.add(publicidad_iluminacion);
            consultasPublicidadesGroup.add(publicidades_consultas_1);
            consultasPublicidadesGroup.add(publicidades_consultas_2);
            consultasPublicidadesGroup.add(publicidades_consultas_3);
            consultasPublicidadesGroup.add(publicidades_consultas_4);
